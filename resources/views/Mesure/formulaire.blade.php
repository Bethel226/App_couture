...
<div class="container shadow p-3 mb-5 bg-body rounded">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form method="POST" class="shadow p-3 mb-5 bg-body rounded" action="{{ route('gestion_mesure.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="col -md-12 mb-3 d-flex">
                    <div class="col -md-6 mb-3" style="margin-right:5px">
